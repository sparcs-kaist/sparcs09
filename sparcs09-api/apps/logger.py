...
class SPARCS09LogHandler(Handler):
    initialized = False
    log_file = None
    log_name = None
    ...
    def emit_db(self, data):
        ...
        self.UserLog(user=user, level=data['level'], ip=data['ip'],
                     group=data['group'], text=data['text'],
                     is_hidden=data['hide']).save()
